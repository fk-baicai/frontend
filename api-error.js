...
(function (global) {
    ...
    var USER_HINTS = {
        ...
        AUTH_S003: '请先登录。',
        SC_IMG_SUB_001: '请上传 jpeg / png / webp / gif，且不超过 6MB。',
        SC_IMG_SUB_002: '请先登录后再上传配件图片。',
        SC_IMG_SUB_003: '图片压缩失败，请换一张后重试。',
        SC_IMG_SUB_004: '待审核图片过多，请等管理员处理后再上传。',
        ...
        AUTH_R006: '注册未通过校验，请确认绑定 ID 正确且 RSI 公民页可访问。',
        AUTH_R007: '未能读取自定义头像时将使用默认头像，登录后可再同步。',
        ...
        AUTH_C005: '当前密码不正确。',
        AUTH_C006: '验证码不正确或已过期，请重新获取。',
        AUTH_C007: '验证码发送失败，请稍后重试。',
        AUTH_E001: '请填写完整信息。',
        AUTH_E002: '两次输入的新邮箱不一致。',
        AUTH_E003: '请填写有效的新邮箱地址。',
        AUTH_E004: '新邮箱不能与当前邮箱相同。',
        AUTH_E005: '该邮箱已被注册，请使用其他邮箱。',
        AUTH_E006: '验证码不正确或已过期，请重新获取。',
        AUTH_E007: '验证码发送失败，请稍后重试。',
        AUTH_H001: '尚未绑定 Handle。',
        AUTH_H002: 'RSI 资料同步失败，请稍后重试。',
        AUTH_H003: '未能读取 RSI 公民页 Biography，请确认 Biography 已保存并公开可见，稍后再试。',
        AUTH_H010: 'RSI 昵称已绑定，不可更换。',
        AUTH_H011: '请先获取验证码。',
        AUTH_H012: 'RSI 简介中的验证码不正确，请确认已保存 Biography 后再试。',
        ...
        OOPZ_006: '请先在首页 OOPZ 设置里开启「语音提示」。',
        OOPZ_007: '你当前不在 OOPZ 语音频道，无法播报。',
        OOPZ_008: '暂无有效射击诸元，请先算出方位与射角。',
        OOPZ_009: 'OOPZ 机器人离线，稍后再试。',
        OOPZ_010: '请先开启射击播报。',
        OOPZ_011: '射击播报冷却中，约 3 秒后再试。',
        ADM_001: '需要管理员权限。',
        ADM_002: '需要超级管理员权限。',
        ADM_011: '进入管理系统前需完成邮箱二次验证。',
        ADM_012: '管理二次验证已失效，请重新验证。',
        ADM_013: '验证码发送失败，请稍后重试。',
        ADM_014: '请选择有效的验证期限（7 / 30 / 180 / 360 天）。',
        ADM_016: '炮兵助手权限名单含无效 Handle。',
        ARTY_004: '无炮兵助手权限，请使用本人已授权账号。',
        ARTY_007: '名单中含未注册网站用户，请先确认对方已注册。',
        ...
        IP_001: '服务器 IP 尚未上报。',
        BRG_004: '上报密钥无效。',
        MKT_022: '当前交易状态不允许此操作。',
        MKT_023: '仅卖家可确认交易。',
        MKT_024: '仅买家可确认完成交易。',
        MKT_025: '须卖家确认交易后才能完成。',
        MKT_026: '请给出 1-5 星评价。',
        MKT_028: '须卖家上传交易凭证后才能完成交易。',
        MKT_029: '请先上传转账截图。',
        MKT_033: '已提交凭证后不可取消订单。',
        MKT_036: '仅已取消的订单可删除。',
        MKT_038: '仅超级管理员可在物品互换中使用积分。',
        MKT_039: '积分只能出现在互换的一侧。',
        MKT_040: '请填写有效的积分数。',
        MKT_041: 'USS 总部签到积分不足，无法完成互换。',
        MKT_042: '发布挂单前须先完成 RSI 绑定（验证公民 Handle）。',
        MKT_043: '无权限',
        MKT_044: '请填写下架理由',
        MKT_045: '交易已结束，无法继续发送。',
        MKT_046: '请填写聊天内容。',
        MKT_047: '聊天内容过长。',
        MKT_048: '发送过于频繁，请稍后再试。',
        MKT_049: '聊天记录不存在或已删除。',
        MKT_050: '仅超级管理员可在物品互换中发布礼物。',
        MKT_051: '礼物兑换内容无效。可填 HTTPS 官方兑换链接，或兑换码/说明文字。',
        MKT_052: '礼物只能填写在互换的给出一侧。',
        MKT_053: '换取礼物前请先在账户设置中验证邮箱。',
        MKT_054: '礼物兑换邮件发送失败，请稍后重试。',
        MKT_055: '该订单不是礼物互换。',
        MKT_056: '我方总数须不少于单次给出数量。',
        MKT_057: '礼物链接条数须与我方总数一致，且不可重复。',
        AUTH_V002: '该邮箱已完成验证。',
        AUTH_V003: '验证码错误或过期。',
        AUTH_V004: '验证码发送失败。',
